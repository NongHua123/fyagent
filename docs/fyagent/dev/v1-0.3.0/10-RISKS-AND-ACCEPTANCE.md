...
- Windows Installer 查询 production module 尚未通过 Required CI 的 native x64/ARM64 临时 MSI fixture，或 runner/container metadata 仍依赖 undocumented/sentinel/compatibility 字段；
