...
2. FyAgent updates the configuration file
...
1. Right-click the FyAgent icon in the system tray
...
When switching providers, FyAgent modifies the following files:
