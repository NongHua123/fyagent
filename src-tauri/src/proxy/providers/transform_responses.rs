...
pub(crate) const TOOL_RESULT_ERROR_MARKER: &str = "[fyagent:tool-result-error]";
...
mod tests {
    ...
    fn test_encrypted_reasoning_round_trips_through_anthropic_history() {
        ...
        assert!(thinking["signature"]
            .as_str()
            .is_some_and(|value| value.starts_with("fyagent-openai-reasoning-v1:")));
