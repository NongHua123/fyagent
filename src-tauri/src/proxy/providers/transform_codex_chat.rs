...
//!
//! This module is used when the Codex client talks to FyAgent through the
...
mod tests {
    ...
    fn large_test_image_data_url() -> String {
        let bytes = b"FYAGENT_TOOL_MEDIA_SENTINEL".repeat(400);
    ...
    fn responses_request_to_chat_moves_tool_image_to_synthetic_user_message() {
        ...
        assert_eq!(
            ...
            "[fyagent: media output of tool call call_image]"
        );
    ...
    fn responses_request_to_chat_clamps_stringified_custom_output_residual_base64() {
        ...
        assert!(rewritten.contains("[fyagent: omitted 20000 bytes]"));
    ...
    fn responses_request_to_chat_clamps_only_residual_base64ish_strings() {
        ...
        assert!(tool_content[2]["data"]
            .as_str()
            .unwrap()
            .starts_with("[fyagent: omitted 20000 bytes]"));
