//! Deep link import functionality for FyAgent
//!
//! This module implements the fyagent:// protocol for importing configurations
...
///
/// Represents a parsed fyagent:// URL ready for processing.
